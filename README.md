...
## For the purposes of this Privacy Policy:
    ...
    Application means the software program provided by the Company downloaded by You on any electronic device, named Discord Security

    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Discord Security.
